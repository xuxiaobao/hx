DeductBalanceWindow = function (config) {

    this.formPanel = new Ext.form.FormPanel({
        labelWidth: 75, // label settings here cascade unless overridden
        url: Desktop.contextPath + '/api/member/deduct',
        region: 'center',
        frame: false,
        border: false,
        labelAlign: 'right',
    ...
    DeductBalanceWindow.superclass.constructor.call(this, allConfig);
};

Ext.extend(DeductBalanceWindow, Ext.Window, {
    closeWin: function () {
        this.close();
    },
    submitForm: function () {
