 ...
 * Created by angus
 */
PhoneStatListPanel = function (config) {
    var serviceUrl = Desktop.contextPath + "/api/orderstat/queryfailphone";
    var me = this;
        ...
        items: [
                ...
                listeners: {
                    render:function(p){
                        p.getEl().on('click',function(){
                            WdatePicker({el:'phoneStatList_begin', dateFmt: 'yyyy-MM-dd HH:mm:ss'});
                        });
                    }
                }
            },
            ...
            },
            {
                ...
                listeners: {
                    render:function(p){
                        p.getEl().on('click',function(){
                            WdatePicker({el:'phoneStatList_end', dateFmt: 'yyyy-MM-dd HH:mm:ss'});
                        });
                    }
                }
            },
    ...
    var gridPanel = new Ext.grid.GridPanel({
        ...
        columns: [
            ...
            {id: 'phone', align: 'center', header: "手机号码", width: 150, sortable: true, dataIndex: 'phone'},
    ...
    PhoneStatListPanel.superclass.constructor.call(this, allConfig);
};

Ext.extend(PhoneStatListPanel, Ext.Panel, {
    /**
     * 快速选择时间按钮动作
    ...
    searchBtnClick: function () {
        ...
        if (frm.isValid()) {
            ...
            var btn = Ext.getCmp("phoneStatListSearchBtn");
            btn.disabled = true;
            this.loadGridData(params, this, function () {
                btn.disabled = false;
            });
        };
    },
     ...
     * @param next
     */
    loadGridData: function (params, me, next) {
        ...
        Ext.Ajax.request({
        	   url: Desktop.contextPath + "/api/orderstat/queryfailratio",
        	   method:"GET",
        	   success: function(response){
        		   if(response)
        		   {
        			   ...
        			   if(json.success)
        			   {
        				   me.detailGrid.setSource(json.data);        			   
        			   }
        			   else
        			   {
...
Ext.reg('tab.phonestatlist', PhoneStatListPanel);
