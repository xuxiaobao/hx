EditUserSupLimitWindow = function (config) {
        ...
        items: [
            {
                ...
                cls: 'x-item-disabled',
                name: 'supId',
                value: userSupLimit.get("supId")
            },{
                fieldLabel: '运营商',
                readOnly: true,
                cls: 'x-item-disabled',
                name: 'operator',
                value: userSupLimit.get("operator")
            },{
                fieldLabel: '限制数',
                name: 'limitNum',
                value: userSupLimit.get("limitNum")
            }
        ]
    });
    ...
    EditUserSupLimitWindow.superclass.constructor.call(this, allConfig);
};

Ext.extend(EditUserSupLimitWindow, Ext.Window, {
    submitForm: function () {
...
Ext.reg('win.editSp', EditUserSupLimitWindow);
