AddDiscountWindow = function (config) {

    var formPanel = new Ext.FormPanel({
        region: 'center',
        labelWidth: 75, // label settings here cascade unless overridden
        url: Desktop.contextPath + '/api/userDiscount/create',
        border: false,
        //title: 'Simple Form',
    ...
    AddDiscountWindow.superclass.constructor.call(this, allConfig);
};

Ext.extend(AddDiscountWindow, Ext.Window, {
    submitForm: function () {
...
Ext.reg('win.addDiscount', AddDiscountWindow);
